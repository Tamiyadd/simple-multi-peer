...
SimpleMultiPeer.prototype.registerPeerEvents = function(peer, id) {
  ...
  console.log(id);
  console.log('====================================');
  ['Connect', 'Signal', 'Data', 'Close', 'Stream'].forEach(function(event) {
    console.log('====================================');
    console.log(this);
    console.log('====================================');
...
SimpleMultiPeer.prototype.onPeerStream = function(id, stream) {
  this.callbacks.stream && this.callbacks.stream.call(this, id, stream);
};
